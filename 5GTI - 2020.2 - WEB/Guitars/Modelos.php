<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-4 text-center" id="DivFotoModelo">
                    <img class="img-thumbnail" src="img/mod1.png">
                </div>
                
                <div class="col-md-8 text-center" id="DivTextoModelo">
                    <font class="TituloCard">Telecaster</font>
                    <p>
