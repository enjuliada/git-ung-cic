    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-3" id="DivMod2">

                    <div class="card" id="CardMod2">
                        <div class="card-body">
                            <a href="#" onclick="mostraDiv(2,1);">
                            <img src="img/stratoMini.jpg" class="ImgMod">
                            </a>
                        </div>
                        <div class="card-footer" style="padding-top:0px;">
                            <center>
                                <a class="TituloMod">Stratocaster</a>
                            </center>
                        </div>
                    </div>
                </div>
        ...
        <div id="DivInfo1">
            ...
            <center>
                ...
                <a href="#" onclick="mostraDiv(1,0);">
                    <i class="fa fa-close fa-2x text-white float-right"></i>
                </a>
                
                <br><br>
                <img src="img/telebutter.jpg" id="ImgInfo">
        ...
        <div id="DivInfo2">
            <div class="card" id="CardInfo">
            <center>
                <font class="TituloMod">Stratocaster</font>                
                
                <a href="#" onclick="mostraDiv(2,0);">
                    <i class="fa fa-close fa-2x text-white float-right"></i>
                </a>
                
                <br><br>
                <img src="img/stratocherry.jpg" id="ImgInfo">
